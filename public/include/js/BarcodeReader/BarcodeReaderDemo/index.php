                    ...
                    <li class="on">
                        <label for="chkLinear">
                            ...
                            <div class="imgWrapper">
                                <img src="assets/images/oned.gif" width="60" alt="Barcode Type Linear" /></div>
                        </label>
                    </li>
					<li class="on">
                        <label for="chkQRCode">
                            <input id="chkQRCode" name="BarcodeType" type="checkbox"  checked="true" value="0x4000000">
                            <span>QRCode</span><br />
                            <div class="imgWrapper">
                                <img src="assets/images/qr.gif" width="40" alt="Barcode Type QRCode" /></div>
                        </label>
                    </li>
        		    <li class="on">
                        <label for="chkPDF417">
                            <input id="chkPDF417" name="BarcodeType" type="checkbox"  checked="true" value="0x2000000">
                            <span>PDF417</span><br />
                            <div class="imgWrapper">
                                <img src="assets/images/pdf417.gif" width="60" height="38" alt="Barcode Type PDF417" /></div>
                        </label>
                    </li>                
					<li class="on">
                        <label for="chkDataMatrix">
                            <input id="chkDataMatrix" name="BarcodeType" type="checkbox"  checked="true" value="0x8000000">
                            <span>DataMatrix</span><br />
                            <div class="imgWrapper">
                                <img src="assets/images/dm.gif" width="40" alt="Barcode Type DataMatrix" /></div>
                        </label>
                    </li>
					<li class="on">
                        <label for="chkAztec">
                            <input id="chkAztec" name="BarcodeType" type="checkbox"   checked="true" value="0x10000000">
                            <span>Aztec</span><br />
                            <div class="imgWrapper">
                                <img src="assets/images/aztec.gif" width="40" alt="Barcode Type Aztec" /></div>
                        </label>
                    </li>
                </ul>
            </div>
